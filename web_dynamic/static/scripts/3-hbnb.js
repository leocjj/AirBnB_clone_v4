...
$.get('http://05c25b3efdc0.19.hbtn-cod.io:37166/api/v1/status/', function (data, status) {
  if (data.status === 'OK') {
...
$.ajax({
  type: 'POST',
  url: 'http://05c25b3efdc0.19.hbtn-cod.io:37166/api/v1/places_search/',
